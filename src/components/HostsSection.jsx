...
export default function HostsSection({ t }) {
  ...
  return (
    ...
    >
      ...
      <motion.div
        className="font-display text-[clamp(1.6rem,5vw,2.4rem)] font-light text-text-mid mb-3"
      ...
      <motion.div
        className="font-display text-[clamp(2.2rem,8vw,3.5rem)] font-light text-text-deep leading-tight tracking-[-0.01em]"
      ...
      >
        ...
        <span className="text-gold-light text-xs tracking-[0.6em]">✦ ✦ ✦</span>

  ...
  return (
    ...
    >
      <div className="max-w-[640px] mx-auto">
        ...
        <motion.h2
          className="font-display text-[clamp(1.6rem,5vw,2.4rem)] font-light text-text-deep mb-8"
        ...
        >
          <div
            ...
            style={{ border: '1px solid #E8D5A3', background: '#FDFBF7' }}
          >
            {/* Venue header */}
            <div className="px-6 py-7">
              <div className="font-display text-[2rem] font-light text-text-deep tracking-[0.04em]">
                Dastur Hall
              </div>
              <div className="font-body font-light text-[12px] tracking-[0.2em] text-text-soft mt-1 uppercase">
                Шахтеров 35/1 · Қарағанды
              </div>

              <div className="w-10 h-px mx-auto my-5" style={{ background: '#E8D5A3' }} />

              <div className="font-body font-light text-[11px] tracking-[0.2em] text-gold uppercase">
                {t.locDate}
              </div>
            </div>
            ...
            <div className="px-6 py-5">
              <a
                ...
                className="inline-block px-8 py-3 font-body text-[9px] font-light tracking-[0.35em] uppercase text-gold-dark transition-all duration-300 hover:text-ivory group relative overflow-hidden"
